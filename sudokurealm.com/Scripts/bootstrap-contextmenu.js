...
!(function($) {
  ...
  ContextMenu.prototype = {
    ...
    ,toggle: function(e) {
      ...
      if (board.selectBox.isShown)
          ...
          //alert($contextmenu.);
          //$contextmenu.data('i', $this.closest('td').data('i'));
        //$contextmenu.data('j', $this.closest('td').data('j'));
          
          board.selectedPosI = $this.closest('td').data('i');
          board.selectedPosJ = $this.closest('td').data('j');
          board.selectedBlockI = $this.closest('td').data('blockI');
          board.selectedBlockJ = $this.closest('td').data('blockJ');
  ...
  function getPosition(e, $this, $menu) {
    var mouseX = e.pageX
      ...
      , Y, X;
    Y = { "top": $this.offset().top-contextY };
    X = { "left": $this.offset().left+contextX };
